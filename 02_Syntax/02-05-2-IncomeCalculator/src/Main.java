...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    while (true) {
      ...
      double incomeInvest = Math.ceil(
          (calculateFixedCharges() + minInvestmentsAmount / (1 - mainTaxPercent)) / (1
              - managerPercent));

      // Запрашиваем и получаем вводом с клавиатуры
      // сумму реализации за месяц (income)
      System.out
          .println("Введите сумму доходов компании за месяц " + "(от 200000 до 900000 рублей),");
