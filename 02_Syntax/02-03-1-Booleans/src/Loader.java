public class Loader {
  ...
  public static void main(String[] args) {
    ...
    if (milkAmount >= 300 + 100 + 1000 && powderAmount >= 5 + 300 + 400 && eggsCount >= 5 + 4
        && appleCount >= 3 && sugarAmount >= 10 && oilAmount >= 30) {
      ...
      boolean canCookOmlAPie =
          (milkAmount >= 300 + 100 && powderAmount >= 5 + 300 && eggsCount >= 5 + 4
              && appleCount >= 3) ? true : false;
      boolean canCookOmlPnc = (milkAmount >= 300 + 1000 && powderAmount >= 5 + 400 && eggsCount >= 5
          && sugarAmount >= 10 && oilAmount >= 30) ? true : false;
      boolean canCookAPiePnc =
          (milkAmount >= 100 + 1000 && powderAmount >= 300 + 400 && eggsCount >= 4
              && appleCount >= 3 && sugarAmount >= 10 && oilAmount >= 30) ? true : false;

      if (canCookOmlAPie == true || canCookOmlPnc == true || canCookAPiePnc == true) {
        System.out.println("Из того, что есть, можно приготовить:");
        if (canCookOmlAPie == true) {
          System.out.println("- Омлет и яблочный пирог");
        }
        if (canCookOmlPnc == true) {
          System.out.println("- Омлет и кекс");
        }
        if (canCookAPiePnc == true) {
          System.out.println("- Яблочный пирог и кекс");
        }
        System.out.println("Два блюда вместе, или любое из них отдельно!");
      } else {
        boolean canCookOml =
            (milkAmount >= 300 && powderAmount >= 5 && eggsCount >= 5) ? true : false;
        boolean canCookAPie =
            (milkAmount >= 100 && powderAmount >= 300 && eggsCount >= 4 && appleCount >= 3) ? true
                : false;
        boolean canCookPnc =
            (milkAmount >= 1000 && powderAmount >= 400 && sugarAmount >= 10 && oilAmount >= 30)
                ? true : false;
