...
/**
 * Test for module 4 homework 3 calculator.GeometryCalculator method getTriangleSquare
 */

@DisplayName("Тест метода getTriangleSquare класса calculator.GeometryCalculator")
