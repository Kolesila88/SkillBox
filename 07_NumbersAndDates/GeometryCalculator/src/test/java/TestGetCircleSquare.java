...
/**
 * Test for module 4 homework 3 calculator.GeometryCalculator method getCircleSquare
 */

@DisplayName("Тест метода getCircleSquare класса calculator.GeometryCalculator")
