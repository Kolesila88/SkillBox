...
class TodoListTest {
  ...
  private final List<String> testTodos = List
      .of("buy milk", "learn java", "create app", "send email", "write issue");
  ...
  void addSingleTodo() {
    ...
    todoList.add(todo);
    assertEquals(expected, todoList.getTodo());
  }
  ...
  void addThreeTodos() {
    ...
    assertEquals(todos, todoList.getTodo());
  }
  ...
  void addTodoToExistIndex() {
    ...
    assertEquals(List.of(todos.get(0), addedTodo, todos.get(1), todos.get(2)), todoList.getTodo());
  }
  ...
  void addTodoToNotExistIndex() {
    ...
    assertEquals(List.of(todos.get(0), todos.get(1), todos.get(2), addedTodo), todoList.getTodo());
  }
  ...
  void deleteExistTodo() {
    ...
    todos.forEach(todoList::add);
    todoList.delete(1);
    assertEquals(List.of(todos.get(0), todos.get(2)), todoList.getTodo());
  }
  ...
  void editExistTodo() {
    ...
    assertEquals(List.of(todos.get(0), editedTodo), todoList.getTodo());
  }
