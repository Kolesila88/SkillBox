...
public class RouteCalculator {
  ...
  private List<Station> getRouteOnTheLine(Station from, Station to) {
    ...
    List<Station> stations = from.getLine().getStationList();
    int direction = 0;
  ...
  private List<Station> getRouteWithOneConnection(Station from, Station to) {
    ...
    List<Station> fromLineStations = from.getLine().getStationList();
    List<Station> toLineStations = to.getLine().getStationList();
